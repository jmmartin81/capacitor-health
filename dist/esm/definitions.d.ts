...
export declare type HealthSampleType = 'steps' | 'heartRate' | 'activeEnergyBurned' | 'distanceWalkingRunning' | 'bloodGlucose' | 'oxygenSaturation' | 'restingHeartRate' | 'respiratoryRate' | 'bodyMass' | 'bodyFatPercentage' | 'bloodPressureSystolic' | 'bloodPressureDiastolic';
